(function () {
  ...
  const exactTranslations = {
    ...
    '10 个吨级资产': '10 Tonnage-Class Assets',
    '微挖': 'Mini Excavator',
    ...
    '7-24 吨级补齐市政、土方和基础施工场景。': 'The 7-24 t range extends coverage to municipal, earthmoving, and foundation applications.',
    ...
    '挖掘机系列已建立统一的吨级、工况、参数、配置贡献、综合排名和提升模拟模型，覆盖 10 个吨级区间。': 'Excavator assets use a consistent model for tonnage classes, work conditions, specifications, configuration contribution, overall ranking, and improvement simulation across 10 tonnage ranges.',
    '1-4 吨紧凑型': '1-4 t Compact',
    '4-6 吨通用型': '4-6 t General Purpose',
    '7-10 吨级': '7-10 t Class',
    '12-24 吨级': '12-24 t Class',
    ...
    '十个吨级统一覆盖狭窄空间、沟槽、土方装车、破碎、坡地和租赁六类典型工况；卡片仅突出各吨级的差异化应用。': 'All ten tonnage classes use six representative work conditions: confined sites, trenching, truck loading, attachment work, slopes, and rental use. Each asset row highlights only the applications that differentiate its class.',
    '吨级筛选': 'Tonnage Filter',
