...
<div class="layout" id="top"><aside class="nav">
  ...
  <button class="sidebarToggle" type="button" aria-expanded="true" aria-controls="page-nav"><span data-en="Collapse navigation">收起侧栏</span></button>
...
{render_site_credits()}
</main></div><script src="assets/dashboard.js?v={asset_version}"></script><script src="assets/i18n.js?v=20260805e"></script></body></html>'''
...
def build_all() -> list[Path]:
    ...
    market_path.write_text(render_market_report_page(asset_version), encoding="utf-8")
    ...
    for sheet in workbook.sheets:
        ...
        output.write_text(render_page(sheet, asset_version), encoding="utf-8")
