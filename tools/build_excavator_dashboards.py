...
.sourceDataChart>figcaption{display:flex;align-items:center;min-height:42px;padding:10px 14px;border-bottom:1px solid #d7e2ec;background:#f3f8fb;color:#073c70;font-size:var(--font-body);font-weight:900;line-height:1.4}
...
.sourceChartValue,.sourceChartTotal,.sourceChartGrowthValue{fill:#082f54!important;font-size:var(--font-min)!important;font-weight:900}
.sourceChartSegmentValue{fill:#fff!important;font-size:var(--font-min)!important;font-weight:900;paint-order:stroke;stroke:rgba(0,35,68,.38);stroke-width:2px}
...
.sourceChartBubbleLabel{fill:#0a355c!important;font-size:var(--font-min)!important;font-weight:900}
.sourceChartBubbleValue{fill:#60758a!important;font-size:var(--font-min)!important;font-weight:800}
...
.sourceChartDonutTotal{fill:#073c70;font-size:var(--font-4xl);font-weight:900}
.sourceChartDonutLabel{fill:#64798c;font-size:var(--font-min);font-weight:800;letter-spacing:.08em}
...
.sourceVisualAction{position:absolute;right:8px;bottom:8px;padding:5px 8px;border:1px solid rgba(255,255,255,.68);background:rgba(4,45,80,.88);color:#fff;font-size:var(--font-min);font-weight:800;line-height:1.2;opacity:0;transform:translateY(3px);transition:opacity .15s ease,transform .15s ease}
...
.mediaViewerHeader small{display:block;margin-bottom:2px;color:#9fc5df;font-size:var(--font-min);font-weight:800;text-transform:uppercase}
